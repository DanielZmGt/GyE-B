...
moldings: list[MoldingInternal] = [
    MoldingInternal(name_es="Acrílico", name_en="Acrylic", file="/assets/moldings/acrylic.svg", category_es="Moderno", category_en="Modern"),
    MoldingInternal(name_es="Aliso", name_en="Alder", file="/assets/moldings/alder.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Fresno", name_en="Ash", file="/assets/moldings/ash.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Bambú", name_en="Bamboo", file="/assets/moldings/bamboo.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Madera de Granero", name_en="Barnwood", file="/assets/moldings/barnwood.svg", category_es="Rústico", category_en="Rustic"),
    MoldingInternal(name_es="Zócalo", name_en="Baseboard", file="/assets/moldings/baseboard.svg", category_es="Clásico", category_en="Classic"),
    MoldingInternal(name_es="Haya", name_en="Beech", file="/assets/moldings/beech.svg", category_es="Madera", category_en="Wood"),
    ...
    MoldingInternal(name_es="Bronce", name_en="Bronze", file="/assets/moldings/bronze.svg", category_es="Metálico", category_en="Metallic"),
    MoldingInternal(name_es="Aluminio Cepillado", name_en="Brushed Aluminum", file="/assets/moldings/brushed_aluminum.svg", category_es="Metálico", category_en="Metallic"),
    MoldingInternal(name_es="Madera de Raíz", name_en="Burl Wood", file="/assets/moldings/burl_wood.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Cedro", name_en="Cedar", file="/assets/moldings/cedar.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Pasamanos", name_en="Chair Rail", file="/assets/moldings/chair_rail.svg", category_es="Clásico", category_en="Classic"),
    MoldingInternal(name_es="Carbón", name_en="Charcoal", file="/assets/moldings/charcoal.svg", category_es="Pintado", category_en="Painted"),
    MoldingInternal(name_es="Cerezo", name_en="Cherry", file="/assets/moldings/cherry.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Blanco Desgastado", name_en="Distressed White", file="/assets/moldings/distressed_white.svg", category_es="Rústico", category_en="Rustic"),
    MoldingInternal(name_es="Madera Flotante", name_en="Driftwood", file="/assets/moldings/driftwood.svg", category_es="Rústico", category_en="Rustic"),
    MoldingInternal(name_es="Roble Ebonizado", name_en="Ebonized Oak", file="/assets/moldings/ebonized_oak.svg", category_es="Moderno", category_en="Modern"),
    MoldingInternal(name_es="Dorado", name_en="Gilded Gold", file="/assets/moldings/gilded_gold.svg", category_es="Metálico", category_en="Metallic"),
    MoldingInternal(name_es="Envuelto en Cuero", name_en="Leather Wrapped", file="/assets/moldings/leather_wrapped.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Caoba", name_en="Mahogany", file="/assets/moldings/mahogany.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Arce", name_en="Maple", file="/assets/moldings/maple.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Madera de Olivo", name_en="Olive Wood", file="/assets/moldings/olive_wood.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Pino", name_en="Pine", file="/assets/moldings/pine.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Latón Pulido", name_en="Polished Brass", file="/assets/moldings/polished_brass.svg", category_es="Metálico", category_en="Metallic"),
    MoldingInternal(name_es="Corazón Púrpura", name_en="Purpleheart", file="/assets/moldings/purpleheart.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Ratán", name_en="Rattan", file="/assets/moldings/rattan.svg", category_es="Natural", category_en="Natural"),
    MoldingInternal(name_es="Roble Rojo", name_en="Red Oak", file="/assets/moldings/red_oak.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Palo de Rosa", name_en="Rosewood", file="/assets/moldings/rosewood.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Sapele", name_en="Sapele", file="/assets/moldings/sapele.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Arce Espaltado", name_en="Spalted Maple", file="/assets/moldings/spalted_maple.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Teca", name_en="Teak", file="/assets/moldings/teak.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Nogal", name_en="Walnut", file="/assets/moldings/walnut.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Wengué", name_en="Wenge", file="/assets/moldings/wenge.svg", category_es="Exótico", category_en="Exotic"),
    MoldingInternal(name_es="Roble Blanco", name_en="White Oak", file="/assets/moldings/white_oak.svg", category_es="Madera", category_en="Wood"),
    MoldingInternal(name_es="Zebrawood", name_en="Zebrawood", file="/assets/moldings/zebrawood.svg", category_es="Exótico", category_en="Exotic"),
]
