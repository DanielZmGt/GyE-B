-- RESET: Limpiar todo y re-insertar datos limpios
-- Ejecutar UNA SOLA VEZ en el SQL Editor de Supabase

TRUNCATE quote_items, quotes, mat_colors, mat_color_groups, moldings, services, portfolio, products RESTART IDENTITY CASCADE;
